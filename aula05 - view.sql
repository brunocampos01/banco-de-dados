...
SELECT UNIQUE (ambulatorios.nroa, ambulatorios.andar, ambulatorios.capacidade, medicos.codm, medicos.nome , medicos.idade , medicos.especialidade, medicos.cpf, medicos.cidade,
consultas.data, consultas.hora, pacientes.codp, pacientes.nome, pacientes.doenca, pacientes.idade, pacientes.cpf, pacientes.cidade)
FROM ambulatorios JOIN medicos ON ambulatorios.nroa=medicos.nroa JOIN consultas ON medicos.codm=consultas.codm JOIN pacientes ON consultas.codp=pacientes.codp
